 ...
 * @info: A pointer to the info_t structure containing shell information.
 * @str: The alias definition to set.
 *
 * Return: 0 on success, -1 on failure.
 */
...
/**
 * print_alias - Print the aliases stored in the shell.
 * @node: A pointer to a linked list node containing alias information.
 *
 * Return: The number of aliases printed.
 */
